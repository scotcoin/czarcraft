...
final class PeerImpl implements Peer {
    ...
    void connect() {
        ...
        if (response != null) {
            ...
            if (analyzeHallmark(announcedAddress, (String)response.get("hallmark"))  && version!=null && ( Constants.isTestnet ? version.startsWith("NFD-TESTNET-") : version.startsWith("NFD-"))) {
